...
| :-------: | :--------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------- |
| ArrayList | Incrementa o disminuye sus elementos de manera dinamica, que se puede encontrar en el paquete `java.util`. | import java.util.ArrayList; // import the ArrayList class |
